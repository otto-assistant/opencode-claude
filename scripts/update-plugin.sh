#!/usr/bin/env bash
#
# update-plugin.sh — Automatically pull the latest opencode-claude plugin
...
#
# The script:
#   1. Checks the latest `@otto-assistant/opencode-claude` version on npm.
...
# ── Config ──────────────────────────────────────────────────────────────────
PLUGIN_NAME="@otto-assistant/opencode-claude"
